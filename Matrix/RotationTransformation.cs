...
public class RotationTransformation : Transformation
{
	...
	public float roSpeedX;
	public float roSpeedY;
	public float roSpeedZ;
	...
	public override Vector3 Apply(Vector3 point)
	{
		...
		Vector3 yAxis = new Vector3(-cosX * sinZ, cosX * cosZ - sinX * sinY * sinZ, sinX * cosZ + cosX * sinY * sinZ);
	...
	private void Update()
	{
		rotation.x += Time.deltaTime * roSpeedX;
		rotation.y += Time.deltaTime * roSpeedY;
		rotation.z += Time.deltaTime * roSpeedZ;
	}
}
